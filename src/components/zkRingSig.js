...
const NUM = 32;
const wasmFile_deposit = "./src/components/deposit.wasm";
const zkeyFile_deposit = "./src/components/deposit.zkey";
const wasmFile_withdraw = "./src/components/withdraw.wasm";
const zkeyFile_withdraw = "./src/components/withdraw.zkey";
